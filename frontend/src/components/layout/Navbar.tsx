...
import { Bell, Search, Menu, X, ChevronDown, User, Settings, LogOut, HelpCircle } from 'lucide-react';
...
export const Navbar = ({ toggleSidebar, sidebarOpen }: NavbarProps) => {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, title: 'New project comment', message: 'John Doe commented on your project', time: '2 minutes ago', read: false },
    { id: 2, title: 'Certificate approved', message: 'Your certificate has been verified', time: '1 hour ago', read: false },
    { id: 3, title: 'System update', message: 'The platform will be updated tonight', time: '3 hours ago', read: true },
  ]);
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setSearchResults([
        { id: 1, type: 'project', title: 'React Dashboard', url: '/projects/1' },
        { id: 2, type: 'certificate', title: 'JavaScript Advanced', url: '/certificates/2' },
        { id: 3, type: 'project', title: 'React Native App', url: '/projects/3' },
      ]);
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            ...
            <Link href={ROUTES.DASHBOARD.ROOT} className="flex items-center ml-3">
                            ...
                            >
                              <div className="flex items-center">
                                <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                                  result.type === 'project' ? 'bg-blue-100 text-blue-600' : 'bg-green-100 text-green-600'
                                } dark:bg-gray-700`}>
