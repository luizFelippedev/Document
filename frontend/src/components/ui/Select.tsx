...
export const Select = forwardRef<HTMLDivElement, SelectProps>(
  ({
    ...
    const [dropdownPosition, setDropdownPosition] = useState<'bottom' | 'top'>(position === 'auto' ? 'bottom' : position);
    ...
    useEffect(() => {
      if (position === 'auto' && isOpen && containerRef.current && dropdownRef.current) {
    ...
    const selectClasses = cn(
      ...
      getSizeStyles(),
      {
        ...
        'border-red-300 focus-within:border-red-500 focus-within:ring-red-500 dark:border-red-800': !!error,
        'border-gray-300 focus-within:border-blue-500 focus-within:ring-blue-500 dark:border-gray-600 dark:focus-within:border-blue-500': !error,
      },
      className
    );
          ...
          <AnimatePresence>
            {isOpen && (
              <motion.div
                ...
                exit={{ opacity: 0, y: dropdownPosition === 'top' ? 10 : -10, transition: { duration: 0.2 } }}
              ...
              >
                ...
                >
                  ...
                  {/* Create option */}
                  {creatable && searchQuery && !filteredOptions.some(option => 
