...
export interface BadgeProps extends React.HTMLAttributes<HTMLSpanElement> {
  ...
  variant?: 'primary' | 'secondary' | 'success' | 'danger' | 'warning' | 'info' | 'default' | 'outline';
  /** Badge size */
  size?: 'sm' | 'md' | 'lg';
...
export const Badge = forwardRef<HTMLSpanElement, BadgeProps>(
  ({
    ...
    const outlinedStyles = {
      primary: 'bg-transparent border border-blue-500 text-blue-700 dark:border-blue-400 dark:text-blue-400',
      secondary: 'bg-transparent border border-gray-500 text-gray-700 dark:border-gray-400 dark:text-gray-400',
      success: 'bg-transparent border border-green-500 text-green-700 dark:border-green-400 dark:text-green-400',
      danger: 'bg-transparent border border-red-500 text-red-700 dark:border-red-400 dark:text-red-400',
      warning: 'bg-transparent border border-amber-500 text-amber-700 dark:border-amber-400 dark:text-amber-400',
      info: 'bg-transparent border border-cyan-500 text-cyan-700 dark:border-cyan-400 dark:text-cyan-400',
      default: 'bg-transparent border border-gray-300 text-gray-700 dark:border-gray-500 dark:text-gray-400',
      outline: 'bg-transparent border border-gray-300 text-gray-700 dark:border-gray-500 dark:text-gray-400',
    };
