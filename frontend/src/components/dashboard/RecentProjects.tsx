      ...
      >
        <div className="py-12 text-center">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-6 max-w-md mx-auto">
            Start showcasing your work by creating your first project. Track your progress,
            share your accomplishments, and build your portfolio.
          </p>
          <Button 
            onClick={() => router.push(`${ROUTES.DASHBOARD.PROJECTS}/new`)}
          >
              ...
              <div className="h-40 bg-gray-100 dark:bg-gray-700 overflow-hidden">
                {project.thumbnail ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center">
                    <Briefcase size={36} className="text-gray-400 dark:text-gray-500" />
                  </div>
                )}
