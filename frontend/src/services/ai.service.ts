...
export const aiService = {
   ...
   */
  async generateText({ prompt, maxTokens = 500, temperature = 0.7, options = {} }: AIPromptParams) {
   ...
   */
  async generateImage({ prompt, n = 1, size = '512x512', responseFormat = 'url' }: AIImageParams) {
