...
import { ArrowRight, Check, ChevronDown, Github, ExternalLink } from 'lucide-react';
...
export default function HomePage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Store and verify your credentials with blockchain technology.',
      icon: '🔐',
    },
    {
      title: 'Skill Tracking',
      description: 'Monitor your progress and growth in various skills over time.',
      icon: '📈',
    },
    {
      title: 'AI-Powered Insights',
      description: 'Get personalized recommendations to enhance your portfolio.',
      icon: '🤖',
    },
  ];
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <header 
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          isScrolled ? 'py-3 bg-white dark:bg-gray-900 shadow-md' : 'py-5 bg-transparent'
        }`}
      >
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 md:pr-12">
              ...
              >
                Create a stunning portfolio, manage your projects, and verify your certificates all in one place.
              </motion.p>
              ...
              >
                <Link href={ROUTES.AUTH.REGISTER} className="w-full sm:w-auto">
                  <Button size="lg" rightIcon={<ArrowRight size={16} />} fullWidth>
      ...
      <section id="features" className="py-24 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            >
              Our platform provides all the tools you need to build, showcase, and grow your professional portfolio.
            </motion.p>
          </div>
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <motion.p 
              ...
              transition={{ duration: 0.5, delay: 0.1 }}
            >
              Join thousands of professionals who are showcasing their work and gaining new opportunities.
            </motion.p>
