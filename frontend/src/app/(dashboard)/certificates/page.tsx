...
export default function CertificatesPage() {
      ...
      cell: (row: any) => (
        <div className="flex items-center">
          ...
          <div>
            ...
            <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">{row.issuer}</div>
          </div>
        </div>
      )
    },
  ...
  const issuerOptions = [
    ...
    ...Array.from(new Set(mockCertificates.map(cert => cert.issuer)))
      .map(issuer => ({ label: issuer, value: issuer }))
  ];
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex gap-2">
            <select
              value={verificationFilter === null ? '' : verificationFilter ? 'verified' : 'unverified'}
              onChange={(e) => {
            ...
            {filteredCertificates.length === 0 ? (
              <div className="col-span-full">
                <Card className="p-12 text-center">
                  ...
                  <h3 className="text-xl font-medium text-gray-900 dark:text-white mb-2">No certificates found</h3>
                  ...
                  <Card hoverable clickEffect>
                    <div className="relative aspect-video mb-4 bg-gray-200 dark:bg-gray-700 rounded-t-lg overflow-hidden">
                      {certificate.thumbnailUrl ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center">
                          <Award size={36} className="text-gray-400 dark:text-gray-500" />
                        </div>
                      )}
                      <div className="absolute top-2 right-2">
                        <Badge 
                          ...
                          size="sm" 
                          icon={certificate.verified ? <FileCheck size={14} /> : undefined}
                        />
                      </div>
                    </div>
                    ...
                    <div className="px-4 pb-4">
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">
                        <Link href={`${ROUTES.DASHBOARD.CERTIFICATES.ROOT}/${certificate.id}`} className="hover:text-blue-600 dark:hover:text-blue-400">
                          {certificate.title}
                        </Link>
                      </h3>
                      ...
                      <div className="flex items-center justify-between mt-2">
                        <Link href={`${ROUTES.DASHBOARD.CERTIFICATES.ROOT}/${certificate.id}`}>
