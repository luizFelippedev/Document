  ...
  const mockProjects = [
    {
      ...
      description: 'A modern dashboard for e-commerce analytics and management with real-time sales tracking, inventory management, and customer insights. Built with a focus on performance and usability.',
      status: 'completed',
      category: 'Web Development',
      technologies: ['React', 'Node.js', 'MongoDB', 'Express', 'Redux', 'TailwindCSS'],
    ...
    },
    {
      ...
      description: 'An iOS/Android app for tracking workouts and nutrition with personalized fitness plans and progress tracking.',
      status: 'in-progress',
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <div className="flex flex-wrap items-center gap-2 mt-2">
              <Badge 
                text={project.status === 'completed' ? 'Completed' : 
          ...
          <div className="flex flex-wrap gap-2">
            <Button 
              ...
              onClick={() => router.push(`${ROUTES.DASHBOARD.PROJECTS.EDIT}/${project.id}`)}
            >
              Edit Project
            </Button>
            ...
            >
                ...
                <div className="prose dark:prose-invert max-w-none">
                  ...
                  <ul>
                    {project.technologies.filter((tech: string) => 
                      ['React', 'React Native', 'Redux', 'TailwindCSS', 'TypeScript'].includes(tech)
                  ...
                  <p>
                    ...
                    Key features were developed in priority order based on user feedback and business requirements.
                  </p>
                  
                  <h3>Deployment</h3>
                  <p>
                    The application is deployed using a CI/CD pipeline with automated testing and deployment.
              ...
              <Card title="Architecture Diagram">
                <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center">
                  <p className="text-gray-500 dark:text-gray-400">Architecture diagram will be displayed here</p>
                </div>
              </Card>
            </motion.div>
          )}
                ...
                {project.images && project.images.length > 0 ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      No screenshots or images have been added to this project yet.
                    </p>
                  </div>
                )}
              </Card>
                ...
                {project.comments && project.comments.length > 0 ? (
                  <div className="space-y-4">
                    {project.comments.map((comment: any) => (
                      <div key={comment.id} className="flex gap-4 p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
                  ...
                  <div className="text-center py-8">
                    ...
                    <h3 className="text-xl font-medium text-gray-900 dark:text-white mb-2">No comments yet</h3>
