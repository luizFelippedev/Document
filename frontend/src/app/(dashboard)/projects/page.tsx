  ...
  const columns = [
      ...
      cell: (row: any) => (
        <div className="flex items-center">
          ...
          <div>
            ...
            <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">{row.category}</div>
          </div>
        </div>
      )
    },
    {
      ...
      cell: (row: any) => {
        ...
        const status = statusMap[row.status] || { color: 'default', label: row.status };
                  ...
                  <Card hoverable clickEffect>
                    ...
                    <div className="px-4 pb-4">
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                        <Link href={`${ROUTES.DASHBOARD.PROJECTS.ROOT}/${project.id}`} className="hover:text-blue-600 dark:hover:text-blue-400">
                          {project.title}
                        </Link>
                      </h3>
