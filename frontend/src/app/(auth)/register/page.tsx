        ...
        <div className="w-full max-w-md p-8">
          ...
          {currentStep === 3 && (
            <div className="mt-6 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Registration Complete!</h3>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <Link href={ROUTES.AUTH.LOGIN} className="text-blue-600 hover:text-blue-500 dark:text-blue-400">
                Sign in
              </Link>
            </p>
          </div>
