          ...
          >
            {isVerifying ? (
              ...
              <div className="text-center py-4">
                ...
                <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Invalid or Expired Link</h3>
              ...
              <>
                <ResetPasswordForm token={params.token} onSuccess={handleResetSuccess} />
