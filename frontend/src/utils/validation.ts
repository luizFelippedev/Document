...
export const validationSchemas = {
  ...
  profile: z.object({
    ...
    jobTitle: z.string().max(100, 'Job title cannot exceed 100 characters').optional().nullable(),
    company: z.string().max(100, 'Company cannot exceed 100 characters').optional().nullable(),
  }),
...
export const validators = {
  ...
  isStrongPassword: (password: string): boolean => patterns.password.test(password),
