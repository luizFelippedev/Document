...
import { format, formatDistance, formatRelative, parseISO, isValid, differenceInDays, differenceInMonths, differenceInYears } from 'date-fns';
import { DATE_FORMATS } from '@/config/constants';

/**
 * Format a date string using the default format
 */
export const formatDate = (dateString: string, dateFormat = DATE_FORMATS.default): string => {
  try {
 ...
 */
export const formatRelativeDate = (dateString: string, baseDate = new Date()): string => {
  try {
    const date = parseISO(dateString);
